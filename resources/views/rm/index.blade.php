...
<div class="container-fluid p-4">
    ...
    <div class="mb-5">
        ...
        <p class="text-secondary">Pilih kategori layanan untuk mengelola data pasien.</p>
    </div>
                ...
                <div class="card h-100 border-0 shadow-sm rounded-4 overflow-hidden">
                    <div class="card-body p-4 d-flex flex-column">
                        ...
                        <div class="d-flex justify-content-between align-items-start mb-4">
                            <div class="icon-shape bg-danger bg-opacity-10 text-danger rounded-3 d-flex align-items-center justify-content-center">
                        ...
                        <p class="text-muted small mb-0">
                            Pemeriksaan rutin ibu hamil (ANC), riwayat kesehatan, dan pemantauan janin.
                        </p>
                    </div>
                </div>
            </a>
            ...
            <a href="#" class="text-decoration-none card-hover-effect">
                <div class="card h-100 border-0 shadow-sm rounded-4 overflow-hidden">
                    <div class="card-body p-4 d-flex flex-column">
                        ...
                        <p class="text-muted small mb-0">
                            Grafik pertumbuhan anak (BB/TB), status gizi, dan deteksi dini stunting.
                        </p>
                    </div>
                </div>
            </a>
            ...
            <a href="#" class="text-decoration-none card-hover-effect">
                <div class="card h-100 border-0 shadow-sm rounded-4 overflow-hidden">
                    <div class="card-body p-4 d-flex flex-column">
                        ...
                        <div class="d-flex justify-content-between align-items-start mb-4">
                            <div class="icon-shape bg-info bg-opacity-10 text-info rounded-3 d-flex align-items-center justify-content-center">
                        ...
                        <p class="text-muted small mb-0">
                            Jadwal vaksinasi dasar & lanjutan, serta riwayat suntikan anak.
                        </p>
                    </div>
                </div>
            </a>
